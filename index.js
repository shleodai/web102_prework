...
const GAMES_JSON = await JSON.parse(GAMES_DATA);
...
const description = `
${numUnfundedGames === 0 ? 'All of our games are funded!' : 
    `We currently have ${numUnfundedGames} ${numUnfundedGames === 1 ? 'game' : 'games'} that need your help.`}
`;
